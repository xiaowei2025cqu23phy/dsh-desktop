...
- **Per-surface wallpapers + beads pixel filter**: separate wallpapers for main window / phone / screensaver, crop editor, position offset, mask; import your own images and pixelate them locally (no copyright issues); five built-in packs (Deep Space / Beads / Starfield / Geometric / Cyber) applied to all three surfaces in one click.
