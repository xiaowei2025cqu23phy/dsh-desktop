...
上述组件的完整许可证文本以各自发布包(如 `node_modules/<package>/LICENSE`)为准。

本项目的**原创代码**按项目根目录 [LICENSE](LICENSE) 的自定义协议授权
(衍生项目不得商用、必须开源),与第三方组件的 MIT 许可互不影响。
